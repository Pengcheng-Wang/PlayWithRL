...
cmd:option('-learning_rate_decay_after',10000,'in number of epochs, when to start decaying the learning rate')
cmd:option('-learning_rate_decay_freq',10000,'frequency of learning rate decay, in number of epochs')
...
cmd:option('-target_q',1500,'The frequency to update target Q network. Set it to 0 if target Q is not needed.')
