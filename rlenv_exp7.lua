...
-- Date: 12/29/16
-- Time: 5:46 PM
-- This script is modified from rlenv_exp6.lua
-- The main change is that, in backprop, we only calculate dloss/dw along a certain steps.
--
...
cmd:option('-target_q',12000,'The frequency to update target Q network. Set it to 0 if target Q is not needed.')
...
cmd:option('-backward_prop_not_before',18,'The earliest time step form where backprop should reach to')
